...
class QCDEvent 
{
    public:
      ...
      void setMuons(const std::vector<QCDMuon>& fMuons);
      ...
      const QCDMuon&   muon(int i)                    const {return muons_[i];}
      ...
      const std::vector<QCDMuon>& muons()   const {return muons_;}
