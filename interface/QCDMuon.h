...
class QCDMuon 
{
   public:
     ...
     ~QCDMuon() {}
     //------------ Sett methods -----------------------------
     inline void setP4(LorentzVector fP4) {P4_ = fP4;}
     inline void setGen(LorentzVector fP4, float fgenR) {genP4_ = fP4; genR_ = fgenR;}
     inline void setIsLooseMuon(bool p_loose_id) { loose_id_ =  p_loose_id;}
     inline void setIsTightMuon(bool p_tight_id) { tight_id_ = p_tight_id;}
     inline void setIsolationR03(reco::MuonIsolation p_isolation) { isolationR03_ = p_isolation; }
     inline void setIsolationR05(reco::MuonIsolation p_isolation) { isolationR05_ = p_isolation; }
     inline void setPfIsolationR03(reco::MuonPFIsolation p_isolation) { pfIsolationR03_ = p_isolation; }
     //inline void setPfMeanDRIsoProfileR03(reco::MuonPFIsolation p_isolation) { pfMeanDRIsoProfileR03_ = p_isolation; }
     //inline void setPfSumDRIsoProfileR03(reco::MuonPFIsolation p_isolation) { pfSumDRIsoProfileR03_ = p_isolation; }
     inline void setPfIsolationR04(reco::MuonPFIsolation p_isolation) { pfIsolationR04_ = p_isolation; }
     //inline void setPfMeanDRIsoProfileR04(reco::MuonPFIsolation p_isolation) { pfMeanDRIsoProfileR04_ = p_isolation; }
     //inline void setPfSumDRIsoProfileR04(reco::MuonPFIsolation p_isolation) { pfSumDRIsoProfileR04_ = p_isolation; }
