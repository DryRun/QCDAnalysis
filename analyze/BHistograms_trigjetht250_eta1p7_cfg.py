...
event_cuts = cms.VPSet(
	cms.PSet(
		...
		parameters  = cms.vdouble(),
		descriptors = cms.vstring('HLT_HT250_v1', 'HLT_HT250_v2', 'HLT_HT250_v3', 'HLT_HT250_v4', 'HLT_HT250_v5', 'HLT_HT250_v7')
	),
	cms.PSet(
...
process.BHistograms    = cms.EDAnalyzer('BHistograms',
	...
	btag_efficiency_file = cms.string("$CMSSW_BASE/src/CMSDIJET/QCDAnalysis/data/single_jet_btag_eff_lowmass.root"),
)
