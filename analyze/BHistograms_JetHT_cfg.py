...
if options.dataSource != "collision_data" and options.dataSource != "simulation":
	print "[BHistograms_JetHT_loose] ERROR : dataSource must be collision_data or simulation"
	sys.exit(1)

if not options.dataType in ["data", "signal", "background"]:
	print "[BHistograms_JetHT_loose] ERROR : dataType must be data, signal, or background"
	sys.exit(1)
...
##-------------------- User analyzer  --------------------------------
process.BHistograms    = cms.EDAnalyzer('BHistograms_JetHT_loose',
