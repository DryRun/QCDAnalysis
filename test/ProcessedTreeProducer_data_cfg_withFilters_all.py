...
process.ak5 = process.ak7.clone(
    ...
    pfjecService     = 'ak5PFL2L3Residual',
...
inputfilelist=[os.getenv('CMSSW_BASE')+"/src/EventFilter/HcalRawToDigi/data/AllBadHCALLaser.txt"]
