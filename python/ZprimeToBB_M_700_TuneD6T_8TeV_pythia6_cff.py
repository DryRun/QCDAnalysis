...
configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('default documentation string for ZprimeToBB_M_700_8TeV_TuneD6T_cff.py'),
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/ZprimeToBB_M_700_TuneD6T_8TeV_pythia6_cff.py,v $')
)
