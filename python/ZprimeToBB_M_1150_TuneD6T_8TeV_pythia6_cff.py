...
generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('PMAS(32,1)= 1150           !mass of Zprime',
...
configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('default documentation string for ZprimeToBB_M_1150_8TeV_TuneD6T_cff.py'),
    name = cms.untracked.string('$Source: /cvs/CMSSW/CMSSW/Configuration/GenProduction/python/Attic/ZprimeToBB_M_1150_TuneD6T_8TeV_pythia6_cff.py,v $')
)
