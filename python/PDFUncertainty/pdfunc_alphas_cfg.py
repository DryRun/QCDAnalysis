...
process.pdfUncSelector.SR = cms.string(options.SR)
process.pdfUncSelector.PdfWeightTags =  cms.untracked.VInputTag(
    "pdfWeights:NNPDF23nloas0118",
    "pdfWeights:NNPDF23nloas0117",
    "pdfWeights:NNPDF23nloas0119",
)

# Main path
process.pdfanapath = cms.Path(
    process.myPartons * 
