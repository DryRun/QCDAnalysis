...
process.source = cms.Source("LHESource",
    fileNames = cms.untracked.vstring('file:/home/dryu/Dijets/data/EightTeeEeVeeBee/ZPrime/Zprime_8TeV_ccbar_bbar_only/Events/mZ_400_0.25/events.lhe'),
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('Configuration/Generator/python/Hadronizer_TuneCUETP8M1_8TeV_generic_LHE_pythia8_cff.py nevts:-1'),
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:test.GEN.root'),
