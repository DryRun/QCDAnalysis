...
# with command line options: CMSDIJET/QCDAnalysis/python/PYTHIA6_Tauola_gg_bbH950_bb_8TeV_cff.py --python_filename /uscms/home/dryu/Dijets/CMSSW_5_3_32_patch3/src/CMSDIJET/QCDAnalysis/gen/PYTHIA6_Tauola_gg_bbH950_bb_8TeV_cfg.py --fileout file:PYTHIA6_Tauola_gg_bbH950_bb_8TeV_FastSim_RECOSIM.root --step GEN,FASTSIM,HLT:7E33v2 --mc --eventcontent RECOSIM --datatier GEN-SIM-DIGI-RECO --pileup 2012_Startup_inTimeOnly --geometry DB --conditions auto:mc --beamspot Realistic8TeVCollision --no_exec -n 1000
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('CMSDIJET/QCDAnalysis/python/PYTHIA6_Tauola_gg_bbH950_bb_8TeV_cff.py nevts:1000'),
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:PYTHIA6_Tauola_gg_bbH950_bb_8TeV_FastSim_RECOSIM.root'),
