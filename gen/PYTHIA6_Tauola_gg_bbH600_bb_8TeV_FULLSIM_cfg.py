...
# with command line options: CMSDIJET/QCDAnalysis/python/PYTHIA6_Tauola_gg_bbH600_bb_8TeV_cff.py --fileout file:PYTHIA6_Tauola_gg_bbH600_bb_8TeV_cff_FULLSIM.root --mc --eventcontent AODSIM --datatier GEN-SIM --conditions auto:mc --beamspot Realistic8TeVCollision --step GEN,SIM,DIGI,L1,DIGI2RAW,HLT:GRun,RAW2DIGI,L1Reco,RECO --python_filename PYTHIA6_Tauola_gg_bbH600_bb_8TeV_FULLSIM_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 64
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('CMSDIJET/QCDAnalysis/python/PYTHIA6_Tauola_gg_bbH600_bb_8TeV_cff.py nevts:64'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:PYTHIA6_Tauola_gg_bbH600_bb_8TeV_cff_FULLSIM.root'),
...
process.GlobalTag = GlobalTag(process.GlobalTag, 'START53_V29A::All', '')
