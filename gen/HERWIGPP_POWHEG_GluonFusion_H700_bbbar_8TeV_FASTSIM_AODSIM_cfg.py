...
# with command line options: CMSDIJET/QCDAnalysis/python/HERWIGPP_POWHEG_GluonFusion_H700_bbbar_8TeV_cff.py --python_filename /uscms/home/dryu/Dijets/CMSSW_5_3_32_patch3/src/CMSDIJET/QCDAnalysis/gen/HERWIGPP_POWHEG_GluonFusion_H700_bbbar_8TeV_FASTSIM_AODSIM_cfg.py --fileout file:HERWIGPP_POWHEG_GluonFusion_H700_bbbar_8TeV_FASTSIM_AODSIM.root --step GEN,FASTSIM,HLT:7E33v2 --mc --eventcontent AODSIM --datatier GEN-SIM-DIGI-RECO --pileup 2012_Startup_inTimeOnly --geometry DB --conditions auto:mc --beamspot Realistic8TeVCollision --no_exec -n 5000
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:HERWIGPP_POWHEG_GluonFusion_H700_bbbar_8TeV_FASTSIM_AODSIM.root'),
...
process.generator = cms.EDFilter("ThePEGGeneratorFilter",
    ...
    GluonFusionHbbParameters = cms.vstring('cd /Herwig/MatrixElements/', 
        'insert SimpleQCD:MatrixElements[0] PowhegMEHiggs', 
        'set /Herwig/Particles/h0:NominalMass 700.*GeV', 
