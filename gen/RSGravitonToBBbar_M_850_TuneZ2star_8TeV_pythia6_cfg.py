...
# with command line options: CMSDIJET/QCDAnalysis/python/RSGravitonToBBbar_M_850_TuneZ2star_8TeV_pythia6_cff.py --python_filename /uscms/home/dryu/Dijets/CMSSW_5_3_32_patch3/src/CMSDIJET/QCDAnalysis/gen/RSGravitonToBBbar_M_850_TuneZ2star_8TeV_pythia6_cfg.py --fileout file:RSGravitonToBBbar_M_850_TuneZ2star_8TeV_pythia6_FastSim_RECOSIM.root --step GEN,FASTSIM,HLT:7E33v2 --mc --eventcontent RECOSIM --datatier GEN-SIM-DIGI-RECO --pileup 2012_Startup_inTimeOnly --geometry DB --conditions auto:mc --beamspot Realistic8TeVCollision --no_exec -n 1000
...
process.configurationMetadata = cms.untracked.PSet(
    ...
    annotation = cms.untracked.string('CMSDIJET/QCDAnalysis/python/RSGravitonToBBbar_M_850_TuneZ2star_8TeV_pythia6_cff.py nevts:1000'),
...
process.RECOSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:RSGravitonToBBbar_M_850_TuneZ2star_8TeV_pythia6_FastSim_RECOSIM.root'),
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    PythiaParameters = cms.PSet(
        ...
        processParameters = cms.vstring('PMAS(347,1)= 850         ! mass of RS Graviton', 
